...
import { of, Observable, Subject, BehaviorSubject, combineLatest, merge, ReplaySubject } from 'rxjs';
import { CollectionViewer } from '@angular/cdk/collections';
import { Sort } from '@angular/material';
import { FilterCondition, PagedResult } from '../resource-util/resources.service';
import { startWith, switchMap, map, debounceTime, tap, catchError } from 'rxjs/operators';
                            ...
                            return this.service.fetch(
                                ...
                                switchMap((pagedResult) => {
                                    return merge(
                                        ...
                                        this.nextPage.pipe(
                                            switchMap(() => this.service.fetchNextPage(currentPagedResult))
                                        ),
